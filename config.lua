...
soeLSTextName = "Los Santos" -- Text used for the LS SOE display name
soeBCTextName = "Blaine County" -- Text used for the BC SOE display name
soePBTextName = "Paleto Bay" -- Text used for the PB SOE display name
soeLSTextNameShort = "LS" -- Text used for the LS SOE display name
soeBCTextNameShort = "BC" -- Text used for the BC SOE display name
soePBTextNameShort = "PB" -- Text used for the PB SOE display name
